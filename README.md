...
- This repository focuses on my own analysis, observations, documentation, and technical reports developed during my cybersecurity learning journey.


OBJECTIVES
Developed practical SOC analyst skills.
Strengthen Blue Team methodologies.
Practice network traffic and log analysis.
Investigate malware and phishing scenarios.
...
LEARNING SOURCE
The concepts documented in this repository were primarily practiced through the TryHackMe SOC Level Learning Path and expanded through independent investigations and hsnds-on analysis.
